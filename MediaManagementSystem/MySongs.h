...
class MySongs
{
	// Using this for the Print (all) songs method to know size of holding array; 
	//it might be a bigger size then actual because i am not subtracting when i 
	//delete a folder (would need to recursively count all subfolder song collections but didnt write it yet)
	int m_nTotalNumOfSongs;
